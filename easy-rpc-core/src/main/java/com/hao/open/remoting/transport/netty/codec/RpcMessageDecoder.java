package com.hao.open.remoting.transport.netty.codec;

import com.hao.open.enums.CompressTypeEnum;
import com.hao.open.enums.SerializationTypeEnum;
import com.hao.open.extension.ExtensionLoader;
import com.hao.open.remoting.constant.RpcConstants;
import com.hao.open.remoting.dto.RpcMessage;
import com.hao.open.remoting.dto.RpcRequest;
import com.hao.open.remoting.dto.RpcResponse;
import com.hao.open.serializer.Serializer;
...
public class RpcMessageDecoder extends LengthFieldBasedFrameDecoder {
    ...
    protected Object decode(ChannelHandlerContext ctx, ByteBuf in) throws Exception {
        // 调用父类 LengthFieldBasedFrameDecoder 的 decode 方法，解决半包粘包的问题，确保接收到的数据都是完整的单数据对象
